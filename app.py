#RAG Q&A Conversation Chatbot with PDF along with Chat history
...
#Enter the Groq api_key
api_key=st.text_input("Enter you Groq_API_KEY:",type="password")
...
if api_key:
    ...
    if uploaded_files:
        ...
        chroma_settings = Settings(
         chroma_db_impl="duckdb+parquet",  # or "duckdb" for in-memory
